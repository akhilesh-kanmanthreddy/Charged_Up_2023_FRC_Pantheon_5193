...
public class RobotContainer {
  ...
  private final JoystickTurret joystickTurret = new JoystickTurret(turret, controller, controller2);
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(
        new AutonDriveStraight(driveTrain, 600)
